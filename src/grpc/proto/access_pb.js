...
proto.access.UserInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.access.UserInfo.repeatedFields_, null);
};
 ...
 * @const
 */
proto.access.UserInfo.repeatedFields_ = [2];
 ...
 */
proto.access.UserInfo.prototype.getRolesList = function() {
...
proto.access.UserInfo.prototype.setRolesList = function(value) {
 ...
 */
proto.access.UserInfo.prototype.addRoles = function(opt_value, opt_index) {
 ...
 */
proto.access.UserInfo.prototype.clearRolesList = function() {
  this.setRolesList([]);
};
